...
async def create_tenant_admin(
    ...
    **Admin Authentication Required**: Only users with admin role can create tenants.
    ...
    # CRITICAL: Set tenant context BEFORE adding to session
    # The tenant.id is auto-generated by uuid.uuid4() when the object is created
    # We must set RLS context to this ID before INSERT, otherwise RLS policy blocks it
